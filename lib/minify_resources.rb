...
module MinifyResources
    CSS_BLOB  = 'public/assets/application.css'
    CSS_DIR   = 'public/assets/css'
    CSS_LIST  = 'public/assets/css/manifest.txt'
    CSS_FILES = File.exists?(CSS_LIST) ? IO.read(CSS_LIST).scan(/\S+/) : Dir.chdir(CSS_DIR){ Dir['*.css'] }

    JS_BLOB   = 'public/assets/application.js'
    JS_DIR    = 'public/assets/js'
    JS_LIST   = 'public/assets/js/manifest.txt'
    JS_FILES  = File.exists?(Jassets/S_LIST) ? IO.read(JS_LIST).scan(/\S+/) : Dir.chdir(JS_DIR){ Dir['*.js'] }
